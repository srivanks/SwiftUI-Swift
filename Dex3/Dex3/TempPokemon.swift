...
struct TempPokemon: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        while !statsContainer.isAtEnd {
            ...
            case "defense":
                defensive = try statsDictionaryContainer.decode(Int.self, forKey: .value)
            case "attack":
            ...
            case "special-defense":
                specialDefensive = try statsDictionaryContainer.decode(Int.self, forKey: .value)
            case "speed":
