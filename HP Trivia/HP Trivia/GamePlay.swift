        ...
        GeometryReader { geo in
            ZStack {
                ...
                VStack {
                    ...
                    .animation(.easeIn(duration: animateViewsIn ? 2 : 0).delay(animateViewsIn ? 2 : 0), value: tappedCorrectAnswer)
                    Spacer()
                    ...
                    VStack {
                        if tappedCorrectAnswer {
                            Text("Brilliant!")
                                ...
                                .transition(.scale.combined(with: .offset(y: -geo.size.height / 4)))
                        }
                    }.animation(.easeIn(duration: tappedCorrectAnswer ? 1 : 0).delay(tappedCorrectAnswer ? 1 : 0), value: tappedCorrectAnswer)
                    ...
                    VStack{
                        if tappedCorrectAnswer {
                            Button("Next Level > ") {
                                //TODO: Reset level next question
                                animateViewsIn = true
                                tappedCorrectAnswer = true
                                 revealBook = false
                                revealHint = false
                    ...
                    }.animation(.easeIn(duration: tappedCorrectAnswer ? 2.7 : 0).delay(tappedCorrectAnswer ? 2.7 : 0), value: tappedCorrectAnswer)
                    Spacer()
                }
                .foregroundColor(.white)
            }
